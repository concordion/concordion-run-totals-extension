[![Build Status](https://img.shields.io/travis/com/concordion/concordion-run-totals-extension.svg)](https://travis-ci.com/concordion/concordion-run-totals-extension)
